...
SET     veh_careless = a.veh_careless + COALESCE((SELECT SUM(b.veh_careless) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        veh_reckless = a.veh_reckless + COALESCE((SELECT SUM(b.veh_reckless) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        veh_failstopsignal = a.veh_failstopsignal + COALESCE((SELECT SUM(b.veh_failstopsignal) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        veh_failyieldrow = a.veh_failyieldrow + COALESCE((SELECT SUM(b.veh_failyieldrow) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        veh_singveh_highspeed = a.veh_singveh_highspeed + COALESCE((SELECT SUM(b.veh_singveh_highspeed) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        veh_singveh_influence = a.veh_singveh_influence + COALESCE((SELECT SUM(b.veh_singveh_influence) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        veh_singveh_fatal = a.veh_singveh_fatal + COALESCE((SELECT SUM(b.veh_singveh_fatal) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        veh_singveh_injury = a.veh_singveh_injury + COALESCE((SELECT SUM(b.veh_singveh_injury) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        veh_multveh_influence = a.veh_multveh_influence + COALESCE((SELECT SUM(b.veh_multveh_influence) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        veh_multveh_rearend = a.veh_multveh_rearend + COALESCE((SELECT SUM(b.veh_multveh_rearend) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        veh_multveh_rightangle = a.veh_multveh_rightangle + COALESCE((SELECT SUM(b.veh_multveh_rightangle) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        veh_multveh_headon = a.veh_multveh_headon + COALESCE((SELECT SUM(b.veh_multveh_headon) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        veh_multveh_fatal = a.veh_multveh_fatal + COALESCE((SELECT SUM(b.veh_multveh_fatal) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        veh_allfatal = a.veh_allfatal + COALESCE((SELECT SUM(b.veh_allfatal) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        veh_allinjury = a.veh_allinjury + COALESCE((SELECT SUM(b.veh_allinjury) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        veh_allfatalinjury = a.veh_allfatalinjury + COALESCE((SELECT SUM(b.veh_allfatalinjury) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        veh_allcrashes = a.veh_allcrashes + COALESCE((SELECT SUM(b.veh_allcrashes) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        veh_int_weight = a.veh_int_weight + COALESCE((SELECT SUM(b.veh_int_weight) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        ped_carelessreckless = a.ped_carelessreckless + COALESCE((SELECT SUM(b.ped_carelessreckless) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        ped_failyieldrow = a.ped_failyieldrow + COALESCE((SELECT SUM(b.ped_failyieldrow) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        ped_disregardsigns = a.ped_disregardsigns + COALESCE((SELECT SUM(b.ped_disregardsigns) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        ped_highspeed = a.ped_highspeed + COALESCE((SELECT SUM(b.ped_highspeed) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        ped_affected_influence = a.ped_affected_influence + COALESCE((SELECT SUM(b.ped_affected_influence) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        ped_affected_distracted = a.ped_affected_distracted + COALESCE((SELECT SUM(b.ped_affected_distracted) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        ped_straightgrade = a.ped_straightgrade + COALESCE((SELECT SUM(b.ped_straightgrade) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        ped_lefthook_xwalk = a.ped_lefthook_xwalk + COALESCE((SELECT SUM(b.ped_lefthook_xwalk) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        ped_lefthook_noxwalk = a.ped_lefthook_noxwalk + COALESCE((SELECT SUM(b.ped_lefthook_noxwalk) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        ped_midblock = a.ped_midblock + COALESCE((SELECT SUM(b.ped_midblock) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        ped_carstraight_xwalk = a.ped_carstraight_xwalk + COALESCE((SELECT SUM(b.ped_carstraight_xwalk) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        ped_carstraight_noxwalk = a.ped_carstraight_noxwalk + COALESCE((SELECT SUM(b.ped_carstraight_noxwalk) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        ped_righthook = a.ped_righthook + COALESCE((SELECT SUM(b.ped_righthook) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        ped_entermidblock = a.ped_entermidblock + COALESCE((SELECT SUM(b.ped_entermidblock) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        ped_againstsignal = a.ped_againstsignal + COALESCE((SELECT SUM(b.ped_againstsignal) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        ped_walkinroad = a.ped_walkinroad + COALESCE((SELECT SUM(b.ped_walkinroad) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        ped_enterintersection = a.ped_enterintersection + COALESCE((SELECT SUM(b.ped_enterintersection) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        ped_allfatal = a.ped_allfatal + COALESCE((SELECT SUM(b.ped_allfatal) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        ped_allinjury = a.ped_allinjury + COALESCE((SELECT SUM(b.ped_allinjury) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        ped_allfatalinjury = a.ped_allfatalinjury + COALESCE((SELECT SUM(b.ped_allfatalinjury) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        ped_allcrashes = a.ped_allcrashes + COALESCE((SELECT SUM(b.ped_allcrashes) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        ped_int_weight = a.ped_int_weight + COALESCE((SELECT SUM(b.ped_int_weight) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_driver_aggressive = a.bike_driver_aggressive + COALESCE((SELECT SUM(b.bike_driver_aggressive) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_driver_failyield = a.bike_driver_failyield + COALESCE((SELECT SUM(b.bike_driver_failyield) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_driver_disregardsignal = a.bike_driver_disregardsignal + COALESCE((SELECT SUM(b.bike_driver_disregardsignal) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_highspeed = a.bike_highspeed + COALESCE((SELECT SUM(b.bike_highspeed) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_biker_aggressive = a.bike_biker_aggressive + COALESCE((SELECT SUM(b.bike_biker_aggressive) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_biker_failyield = a.bike_biker_failyield + COALESCE((SELECT SUM(b.bike_biker_failyield) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_biker_disregardsignal = a.bike_biker_disregardsignal + COALESCE((SELECT SUM(b.bike_biker_disregardsignal) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_influence = a.bike_influence + COALESCE((SELECT SUM(b.bike_influence) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_driver_distracted = a.bike_driver_distracted + COALESCE((SELECT SUM(b.bike_driver_distracted) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_driver_reckless = a.bike_driver_reckless + COALESCE((SELECT SUM(b.bike_driver_reckless) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_tbone = a.bike_tbone + COALESCE((SELECT SUM(b.bike_tbone) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_opp_lhook = a.bike_opp_lhook + COALESCE((SELECT SUM(b.bike_opp_lhook) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_samedir = a.bike_samedir + COALESCE((SELECT SUM(b.bike_samedir) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_samedir_rhook1 = a.bike_samedir_rhook1 + COALESCE((SELECT SUM(b.bike_samedir_rhook1) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_samedir_rhook2 = a.bike_samedir_rhook2 + COALESCE((SELECT SUM(b.bike_samedir_rhook2) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_perp_rhook = a.bike_perp_rhook + COALESCE((SELECT SUM(b.bike_perp_rhook) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_perp_rhook_swalk1 = a.bike_perp_rhook_swalk1 + COALESCE((SELECT SUM(b.bike_perp_rhook_swalk1) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_perp_rhook_swalk2 = a.bike_perp_rhook_swalk2 + COALESCE((SELECT SUM(b.bike_perp_rhook_swalk2) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_tbone_swalk1 = a.bike_tbone_swalk1 + COALESCE((SELECT SUM(b.bike_tbone_swalk1) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_tbone_swalk2 = a.bike_tbone_swalk2 + COALESCE((SELECT SUM(b.bike_tbone_swalk2) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_allfatal = a.bike_allfatal + COALESCE((SELECT SUM(b.bike_allfatal) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_allinjury = a.bike_allinjury + COALESCE((SELECT SUM(b.bike_allinjury) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_injuryfatal = a.bike_injuryfatal + COALESCE((SELECT SUM(b.bike_injuryfatal) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_allcrashes = a.bike_allcrashes + COALESCE((SELECT SUM(b.bike_allcrashes) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        bike_int_weight = a.bike_int_weight + COALESCE((SELECT SUM(b.bike_int_weight) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0),
        int_weight = a.int_weight + COALESCE((SELECT SUM(b.int_weight) FROM generated.crash_aggregates b WHERE a.node=b.node AND a.int_id < b.int_id),0);
